...
public class C01_MultipleException {
    /*
    ...
    2- eger bir try birden fazla catch blogu olusturacaksak     once child exception icin catch blogu yazmaliyiz,
      sonra parent exception icin.   Cunku parent'dan sonra child'i yazarsak
    ...
    Hataları yazarken Childen parete doğru yazılır yani dardan genişe:
    ...
    */
    public static void main(String[] args)  {
        ...
        } catch (FileNotFoundException e) { // erisim hatası
