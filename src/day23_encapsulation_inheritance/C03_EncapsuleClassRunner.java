...
public class C03_EncapsuleClassRunner {
    public static void main(String[] args) {
        /*
    Encapsulation'in temel amaci read ve write yetkilerini ayirmak
    ve istedigimiz class uyesine read, istedigimiz class uyesine write  yetkisi verebilmektir
    access modifier'i default, protected veya public olanlarda
    read/write yetkilerini ayirmamiz mumkun degil.
    access modifier'i private olan class uyelerine ise hic ulasamiyoruz
